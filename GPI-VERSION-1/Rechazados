<%-- 
    Document   : Rechazados
    Created on : 15/12/2013, 04:14:22 PM
    Author     : Rodrigo
--%>
...
<html>
    ...
    <body>
        ...
        rst = stmt.executeQuery("select * from maestro where EstadoDelProyecto like 'false'");
        ...
        %>
         <div id="Notificacio">
            ...
            while(rst.next()){
                ...
                String Aceptado = rst.getString("EstadoDelProyecto");
                ...
                <td><input type="button" value="<%=NombreProyecto%>" id="BtnIr"></td></tr>
